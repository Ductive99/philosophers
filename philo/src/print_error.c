...
/*   Updated: 2025/09/08 16:01:39 by esouhail         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void load_error_message(char err[6][200])
{
	ft_strncpy(err[ERR_ARGC],
			   ...
			   200);
	ft_strncpy(err[ERR_INVALID_NUMBER],
			   "Invalid Number Error: ", 200);
	ft_strncpy(err[ERR_INT_OVERFLOW],
			   "Int Overflow Error: ", 200);
